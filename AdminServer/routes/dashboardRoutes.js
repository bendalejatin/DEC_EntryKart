...
router.get("/stats", async (req, res) => {
  try {
    ...
    const [societyCount, userCount, couponCount, eventCount] = await Promise.all([
    ...
    res.json({ societies: societyCount, users: userCount, coupons: couponCount, events: eventCount });
  } catch (error) {
