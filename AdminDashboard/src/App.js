...
const App = () => {
  ...
  return (
    <Router>
      {isLoggedIn && <Navbar toggleSidebar={() => setSidebarOpen(!isSidebarOpen)} />}
      <div className="main">
        ...
        <div className="content">
          <Routes>
            ...
            <Route path="/society" element={<ProtectedRoute><SocietyManagement /></ProtectedRoute>} />
            ...
            <Route path="/broadcast" element={<ProtectedRoute><BroadcastMessage /></ProtectedRoute>} />
            <Route path="/flat-owner" element={<ProtectedRoute><FlatOwnerDetails /></ProtectedRoute>} />
            <Route path="/entry-permission" element={<ProtectedRoute><EntryPermissionForm /></ProtectedRoute>} />
